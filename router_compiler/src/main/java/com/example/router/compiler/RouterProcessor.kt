 ...
 */
@AutoService(RouterProcessor::class)
...
class RouterProcessor: AbstractProcessor() {
    ...
    override fun process(annotations : MutableSet<out TypeElement>, roundEnv: RoundEnvironment): Boolean {
        processingEnv.messager.printMessage(Diagnostic.Kind.NOTE, "RouterProcessor process--->: " +
                "roundEnv =$roundEnv, roundEnv.rootElements =${roundEnv.rootElements}")
    ...
    fun generatedClass(routeElements: Set<out Element>) {
        ...
        sb.append("package com.example.routers;\n")
        sb.append("import android.app.Activity;\n")
        sb.append("import com.example.router.IRouteLoad;\n")
        sb.append("import java.util.HashMap;\n")
        sb.append("import com.google.auto.service.AutoService;\n")
        ...
        //类
        val className = moduleName+Random.nextInt(10000)
        sb.append("@AutoService(IRouteLoad.class)\n")
        sb.append("public class "+className+"Router implements IRouteLoad{\n")
        sb.append("@Override\n")
        ...
        //创建kotlin文件
        try {
            var sourceFile: JavaFileObject = filer!!.createSourceFile("com.example.routers."+className+"Router")
            //输出字符串
