...
/*        JoinTest joinTest = new JoinTest();
        ...
        try{
            Class innerclass =Class.forName("com.example.myapplication.JoinTest$InnerClass");
            //Method method = innerclass.getDeclaredMethod("add");
            //method.invoke(innerclass.newInstance(Class.forName("com.example.myapplication.JoinTest").newInstance()));
